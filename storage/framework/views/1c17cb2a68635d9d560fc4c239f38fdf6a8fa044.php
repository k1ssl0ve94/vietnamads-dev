<div class="card card-primary" id="advanced-search" data-cat="<?php echo e(isset($cat) && isset($cat['id']) ? $cat['id'] : ''); ?>" data-sub-cat="<?php echo e(isset($subCat) && isset($subCat['id']) ? $subCat['id'] : ''); ?>" v-cloak>
