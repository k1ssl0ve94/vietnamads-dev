...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'available'             => 'có sẵn',
        'size'                  => 'kích thước',
        'category' => 'hình thức quảng cáo',
        'pano_size' => 'kích thước quảng cáo',
        'pano_type' => 'loại quảng cáo',
        'district' => 'quận/huyện',
        'provider' => 'nhà cung cấp',
        'contact_phone' => 'Só điện thoại',
        'contact_name' => 'tên liên lạc',
        'contact_email' => 'email',
        'contact_address' => 'địa chỉ liên lạc',
        'web_type' => 'dạng website',
        'web_position' => 'trang xuất hiện'
    ],
