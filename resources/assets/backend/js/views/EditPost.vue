        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              <div class="col-sm-9 offset-sm-3">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="" id="formStatus" v-model="form.status">
            ...
            <div class="form-group row">
              <div class="col-sm-9 offset-sm-3">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="" id="formHot" v-model="form.hot">
...
export default {
  ...
  computed: {
    imagePreview() {
      ...
      return '/imgs/img_placeholder.png';
    }
  },
  methods: {
    initSummerNote() {
    ...
    editPost() {
      ...
      axios.put(`/api/admin/posts/${this.id}`, form).then(response => {
        if (response.data.success) {
          this.$store.dispatch('formSuccess', 'Update post success');
          window.scrollTo(0, 0);
          window.scrollTo(0, 0);
        } else {
