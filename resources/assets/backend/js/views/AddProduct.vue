                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="package_value">Service Package</label>
                                        <select
                                            class="form-control"
                                            id="package_value"
                                            name="level"
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="package_option">Active days</label>
                                        <select
                                            class="form-control"
                                            id="package_option"
                                            name="package_option"
                                            v-model="form.package_option"
                                        >
                                            <option value="0">Select active days</option>
                                            <option
                                            ...
                                            >
                                                ...
                                                {{option.days * selectedPackage.fee_point | numFormat}} vnđ
                                            </option>
                                        </select>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        ...
        addProduct() {
            ...
            axios.post('/api/admin/products', this.form).then(response => {
                if (response.data.status) {
                    this.resetFormData();
                    this.$store.dispatch('alertSuccess', 'Add new product success');
                    this.$router.push({
                        name: 'products'
                    });
                } else {
        ...
        getServicePackages() {
            axios.get('/api/admin/services?addProduct=1').then(resp => {
                ...
                this.form.level = this.servicePackages[0].id; // default
            });
        },
