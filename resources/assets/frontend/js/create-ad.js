        ...
        methods: {
            ...
            getProductData() {
                ...
                axios.get(urlGetData).then(response => {
                    this.productData = response.data.product.ad;
                    this.providers = response.data.product.provider;
                    this.ad_channels = response.data.product.ad.channel;
                    this.ad_times = response.data.product.ad.time;
                    this.ad_coverages = response.data.product.ad.coverage;

                    this.categories = response.data.category.filter(cat => cat.parent_id == 2);
                    this.servicePackages = response.data.servicePackages;
                    // this.selectedPackage = this.servicePackages[0];
                    // this.form.level = this.selectedPackage.id;
