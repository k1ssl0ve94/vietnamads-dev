if ($('#form-create-social').length > 0) {
    new Vue({
        el: '#form-create-social',
        data: {
        ...
        methods: {
            ...
            getProductData() {
                ...
                axios.get(urlGetData).then(response => {
                    this.productData = response.data.product.social;
                    this.providers = response.data.product.provider;
                    this.categories = response.data.category.filter(cat => cat.parent_id == 3);
            ...
            submit() {
                ...
                axios
                    .post('/dang-tin/social', this.form)
                    .then(resp => {
                        if (resp.data.status) {
            ...
            reset() {
                ...
                this.$refs.createSocialDropzone.removeAllFiles();
                this.errors = {};
            },
