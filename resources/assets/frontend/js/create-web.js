        ...
        methods: {
            ...
            getProductData() {
                ...
                axios.get(urlGetData).then(response => {
                    this.productData = response.data.product.web;
                    this.providers = response.data.product.provider;
                    this.categories = response.data.category.filter(cat => cat.parent_id == 4);
            ...
            reset() {
                ...
                this.$refs.createWebDropzone.removeAllFiles();
                this.errors = {};
            },
