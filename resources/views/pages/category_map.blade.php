...
@section('main')
<script>
    window.map_params = {!! json_encode($params) !!};
</script>
<div class="row">
    <div class="col-12">
        <div class="card card-primary">
            ...
            <div class="card-body" id="map-container" v-cloak>
                    ...
                    <div class="col-12">
                        <div class="product-filter">
                            <form action="" class="form-inline">
                                ...
                                <a href="{{ $viewListUrl }}" class="btn btn-link">Xem danh sách</a>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <hr>
                <div class="row" id="advanced-search-map" data-cat="{{ $cat ? $cat['id'] : '' }}" data-sub-cat="{{ isset($subCat) && isset($subCat['id']) ? $subCat['id'] : '' }}">
