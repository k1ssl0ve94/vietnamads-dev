<div class="create-product-form" id="form-create-web" v-cloak>
    <form action="" @submit.prevent="submit">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label>Hình thức hiển thị trên trang của bạn <span class="text-danger">*</span></label>
                    <select class="form-control" v-model="form.web_type" required >
                        <option value="">Chọn hình thức hiển thị</option>
                        <option v-for="item in productData.type" :value="item.id">@{{ item.name }}</option>
                    </select>
                    <span v-if="errors.web_type" class="form-text text-danger">@{{ errors.web_type[0] }}</span>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="">Dạng websites bạn cung câp? <span class="text-danger">*</span></label>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="">Trang mà banner sẽ hiển thị? <span class="text-danger">*</span></label>
                    <select class="form-control" v-model="form.web_position" required >
                        <option value="">Chọn trang xuất hiện *</option>
                        <option v-for="item in productData.position" :value="item.id">@{{ item.name }}</option>
                    </select>
                    <span v-if="errors.web_position" class="form-text text-danger">@{{ errors.web_position[0] }}</span>
                </div>
            </div>
        </div>
        <div class="divider"></div>
