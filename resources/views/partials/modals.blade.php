        ...
        <form action="">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{--<div class="form-group">--}}
                        {{--<div class="g-recaptcha" id="subscribe-recaptcha" data-sitekey="{{ env('RECAPTCHA_SITE_KEY') }}"></div>--}}
                    {{--</div>--}}
                </div>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form action="{{route('register')}}" id="fRegisterByPopup" method="POST">
                    {!! csrf_field() !!}
                    <div class="form-group">
                        <input type="email" class="form-control" placeholder="Nhập Email (*)" name="email" required>
                    </div>
                    ...
                    <div class="form-group">
                        <select class="form-control" name="city">
                            ...
                            @foreach (config('city') as $id => $name)
        ...
        <form action="" id="fResendActiveCode">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{--<a href="#" class="showResendSmsWrap">Không nhận được tin kích hoạt? Vui lòng click vào đây</a>--}}
                    {{--<div class="form-group resend_sms_captcha_wrap" style="display: none">--}}
                        {{--<div class="row">--}}
                            {{--<div class="col-12">Gửi lại active code</div>--}}

                            {{--<div class="form-group">--}}
                                {{--{!! NoCaptcha::display() !!}--}}
                            {{--</div>--}}
                            {{--<div class="col-12">--}}
                                {{--<span>Bạn có tối đa 2 lần nhận active code.</span>--}}
                                 {{--<span>Click vào--}}
                                {{--<a href="#" class="btn_resend_sms"><i class=" btn btn-small fa fa-refresh"></i></a> để gửi lại code.</span>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-4 text-right">
                        <a href="{{ route('get-create-product', ['tab' => 1]) }}" class="btn btn-primary mb-2">Biển quảng cáo</a>
                    </div>
                    <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-4 text-right"><a href="{{ route('get-create-product', ['tab' => 2]) }}" class="btn btn-primary mb-2">Quảng cáo truyền thông</a></div>
                    <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-4 text-right">
                        <a href="{{ route('get-create-product', ['tab' => 3]) }}" class="btn btn-primary mb-2">Digital marketing</a>
                    </div>
                    <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-4 text-right">
                        <a href="{{ route('get-create-product', ['tab' => 4]) }}" class="btn btn-primary mb-2">Ads banner</a>
                    </div>
                    <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-4 text-right">
                        <a href="{{ route('get-create-product', ['tab' => 5]) }}" class="btn btn-primary mb-2">Nghiệp vụ khác</a>
                    </div>
                    <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-4 text-right">
                        <a href="{{ route('get-create-product', ['tab' => 6]) }}" class="btn btn-primary mb-2">Cần thuê dịch vụ</a>
                    </div>
                    <div class="col-md-8">
        ...
        <div class="modal-content">
            ...
            <form action="" method="POSt" class="form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Họ tên *</label>
                        <input type="text" class="form-control" name="name" placeholder="" required value="{{ $user->name }}">
                    </div>
                    <div class="form-group">
                        <label>Số điện thoại</label>
                        <input type="text" readonly
                               class="form-control" name="phone" placeholder="" required value="{{ $user->phone }}">
                        <div>
            ...
            <form action="" method="POSt" class="form">
                <div class="modal-body text-center">
                    <p>
                        ...
                        Mã tài khoản bạn có thể lấy trong <a href="{{route('profile')}}">trang cá nhân</a>.<br/>
                    </p>
                    <p>
