<div id="box-search" v-cloak>
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-item nav-link active" id="nav-tab-1" data-toggle="tab" href="#nav-content-1" role="tab"
                aria-controls="nav-content-1" aria-selected="true">{{ $productConfig['category'][0]['name'] }}</a>
            <a class="nav-item nav-link" id="nav-tab-2" data-toggle="tab" href="#nav-content-2" role="tab"
                aria-controls="nav-content-2" aria-selected="false">{{ $productConfig['category'][1]['name'] }}</a>
            <a class="nav-item nav-link" id="nav-tab-3" data-toggle="tab" href="#nav-content-3" role="tab"
                aria-controls="nav-content-3" aria-selected="false">{{ $productConfig['category'][2]['name'] }}</a>
            <a class="nav-item nav-link" id="nav-tab-4" data-toggle="tab" href="#nav-content-4" role="tab"
                aria-controls="nav-content-4" aria-selected="false">{{ $productConfig['category'][3]['name'] }}</a>
            <a class="nav-item nav-link" id="nav-tab-5" data-toggle="tab" href="#nav-content-5" role="tab"
                aria-controls="nav-content-5" aria-selected="false">{{ $productConfig['category'][4]['name'] }}</a>
        </div>
    </nav>
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-content-1" role="tabpanel" aria-labelledby="nav-tab-1">
            ...
            <div class="d-flex">
                <a href="{{ route('category', ['catSlug' => config('product.category')[0]['slug']]) }}" class="mr-auto text-danger font-weight-bold"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ __('msg.search_advanced') }}</a>
                <button class="btn btn-primary btn-sm ml-auto" @click.prevent="searchPano">{{ __('msg.search_fast') }}</button>
            </div>
        </div>
        <div class="tab-pane fade" id="nav-content-2" role="tabpanel" aria-labelledby="nav-tab-2">
            ...
            <div class="d-flex">
                <a href="{{ route('category', ['catSlug' => config('product.category')[1]['slug']]) }}" class="mr-auto text-danger font-weight-bold"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ __('msg.search_advanced') }}</a>
                <button class="btn btn-primary btn-sm ml-auto" @click.prevent="searchAd">{{ __('msg.search_fast') }}</button>
            </div>
        </div>
        <div class="tab-pane fade" id="nav-content-3" role="tabpanel" aria-labelledby="nav-tab-3">
            ...
            <div class="d-flex">
                <a href="{{ route('category', ['catSlug' => config('product.category')[2]['slug']]) }}" class="mr-auto text-danger font-weight-bold"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ __('msg.search_advanced') }}</a>
                <button class="btn btn-primary btn-sm ml-auto" @click.prevent="searchSocial">{{ __('msg.search_fast') }}</button>
            </div>
        </div>
        <div class="tab-pane fade" id="nav-content-4" role="tabpanel" aria-labelledby="nav-tab-4">
            ...
            <div class="d-flex">
                <a href="{{ route('category', ['catSlug' => config('product.category')[3]['slug']]) }}" class="mr-auto text-danger font-weight-bold"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ __('msg.search_advanced') }}</a>
                <button class="btn btn-primary btn-sm ml-auto" @click.prevent="searchAdsBanner">{{ __('msg.search_fast') }}</button>
            </div>
        </div>
        <div class="tab-pane fade" id="nav-content-5" role="tabpanel" aria-labelledby="nav-tab-4">
            ...
            <div class="d-flex">
                <a href="{{ route('category', ['catSlug' => config('product.category')[4]['slug']]) }}" class="mr-auto text-danger font-weight-bold"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ __('msg.search_advanced') }}</a>
                <button class="btn btn-primary btn-sm ml-auto" @click.prevent="searchWeb">{{ __('msg.search_fast') }}</button>
            </div>
        </div>
    </div>
</div>