<div class="create-product-form" id="form-create-social" v-cloak>
    ...
    <div class="row">
        ...
        {{--<div class="col-md-3">--}}
            {{--<div class="form-group">--}}
                {{--<label for="">Loại trang </label>--}}
                {{--<select class="form-control" v-model="form.social_type">--}}
                    {{--<option value="">Chọn loại trang</option>--}}
                    {{--<option v-for="item in productData.type" :value="item.id">@{{ item.name }}</option>--}}
                {{--</select>--}}
                {{--<span v-if="errors.social_type" class="form-text text-danger">@{{ errors.social_type[0] }}</span>--}}
            {{--</div>--}}
        {{--</div>--}}

        {{--<div class="col-md-3">--}}
            {{--<div class="form-group">--}}
                {{--<label for="">Lượt theo dõi</label>--}}
                {{--<select class="form-control" v-model="form.social_follow">--}}
                    {{--<option value="">Chọn lượt theo dõi</option>--}}
                    {{--<option v-for="item in productData.follow" :value="item.id">@{{ item.name }}</option>--}}
                {{--</select>--}}
                {{--<span v-if="errors.social_follow" class="form-text text-danger">@{{ errors.social_follow[0] }}</span>--}}
            {{--</div>--}}
        {{--</div>--}}
    ...
    <div class="row">
        <div class="col-md-6 pt-2">
            <button class="btn btn-primary" @click.prevent="submit">Đăng tin</button>
